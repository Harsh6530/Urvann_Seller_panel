...
const RiderCodesPickedScreen = () => {
  ...
  useEffect(() => {
    axios.get(`http://10.112.104.99:5001/api/sellers/${sellerName}/drivers/picked`)
      .then(response => {
    ...
    axios.get(`http://10.112.104.99:5001/api/sellers/${sellerName}/all?pickup_status=picked`)
    .then(response => {
