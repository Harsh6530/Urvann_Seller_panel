...
const RiderCodesNotPickedScreen = () => {
  ...
  useEffect(() => {
    axios.get(`http://10.112.104.99:5001/api/sellers/${sellerName}/drivers/not-picked`)
      .then(response => {
    ...
    axios.get(`http://10.112.104.99:5001/api/sellers/${sellerName}/all?pickup_status=not-picked`)
      .then(response => {
